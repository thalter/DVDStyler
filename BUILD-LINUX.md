...
```bash
sudo apt install libtool flex libwxgtk3.2-dev libwxgtk3.2-dev libwxgtk-media3.2-1t64 pkg-config libavformat-dev libavcodec-dev libavutil-dev libswscale-dev libavfilter-dev libwxsvg-dev libcairo-dev libpango1.0-dev wx3.2-headers libexif-dev ffmpeg gettext dvdauthor xmlto bison
```
