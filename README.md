...
support high-DPI displays and is not ARM native (it is an Intel build that runs under Rosetta2). By building your own version, you can get support for the latest Apple hardware and OS versions.
